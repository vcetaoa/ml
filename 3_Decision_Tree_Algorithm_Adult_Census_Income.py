# ==============================================================
# Decision Tree Algorithm on Adult Census Income Dataset
# ==============================================================
...
# --- 3. Automatically Detect Target Column ---
target_col = None
...
plt.ylabel("Actual")
plt.show()   # <-- Wait for close to show next graph
...
#it will take some time to run wait for some time you will get total 3/4 graphs
#🧮 Matrices You’ll See Visually
# Type	  Matrix/Graph	                                  Purpose
# 3️⃣	     Decision Tree Plot	                          Visual representation of the learned rules
# 4️⃣	     Feature Importance Plot	                  Shows which attributes influenced income most
#After viewing each graph, close it to proceed to the next one