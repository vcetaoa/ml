# ==============================================================
# Random Forest on Adult Census Income Dataset with Auto Target Detection
# ==============================================================
...
# Heuristic: pick first column with exactly 2 unique values (binary) after stripping
target_col = None
...
# --- 6. Train Base Random Forest Model ---
